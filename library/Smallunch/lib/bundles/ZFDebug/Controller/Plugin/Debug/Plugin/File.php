 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug_Plugin_File implements Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug_Plugin_Interface
{
    /**
