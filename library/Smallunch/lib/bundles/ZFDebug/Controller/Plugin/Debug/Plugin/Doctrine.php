...
* @subpackage Plugins
*/
class Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug_Plugin_Doctrine extends Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug_Plugin implements Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug_Plugin_Interface
{
    /**
...
*/
    public function __construct(array $options = array())
    {
        ...
        foreach ($options['manager']->getIterator() as $connection) {
            ...
            $this->_profilers[$connection->getName()] = Zend_Registry::get('doctrine_conn');
...
*/
    public function getPanel()
    {
        ...
        $html = '<h4>Database queries</h4><ol>';
