 ...
 */
require_once 'Smallunch/lib/bundles/ZFDebug/Controller/Plugin/Debug/Plugin/Text.php';
 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
    /**
    ...
    public function __construct($options = null)
    {
         ...
         */
        $version = new Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug_Plugin_Text();
     ...
     * @return ZFDebug_Controller_Plugin_Debug
     */
    public function registerPlugin(Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug_Plugin_Interface $plugin)
    {
    ...
    protected function _loadPlugins()
    {
    	foreach($this->_options['plugins'] as $plugin => $options) {
    	    ...
    	    if (in_array($plugin, Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug::$standardPlugins)) {
    	        // standard plugin
                $pluginClass = 'Smallunch_lib_bundles_ZFDebug_Controller_Plugin_Debug_Plugin_' . $plugin;
    	    } else {
